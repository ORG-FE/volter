...
class PeerRelayGuardTest {
  ...
  void allowValidSignedIdentity() {
    ...
    Protocol.ClientOptions opt = new Protocol.ClientOptions(32, 1, 1, 2, 256, "peer-a", "n-1", sig);
  ...
  void rejectBadSignature() {
    PeerRelayGuard g = new PeerRelayGuard();
    Protocol.ClientOptions opt = new Protocol.ClientOptions(32, 1, 1, 2, 256, "peer-a", "n-1", "bad");
